...
function Projects() {
    ...
    return (
        <>
            ...
            <div className={menuControl || contactControl ? "ProjectsBody blured" : 'ProjectsBody'}>
                        ...
                        <div className={imgHovered ? 'project-icons project-icons-hovered' : 'project-icons'}>

                            {
                                projects[projectDisplay].icons.map((icon, key) => {
                                    ...
                                    return <div className="project-icon-item" key={key}>
                                        {icon}
                                    </div>
                                })
                            }
