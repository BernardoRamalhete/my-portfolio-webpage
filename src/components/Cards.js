...
function Cards({ cellPhone, darkMode}) {
  const [iconColors, setIconColors] = useState({color1:'#f0386b',color2:'#f9f9f95a'})
  ...
  const [mySQLIconColor, setMySQLIconColor] = useState(iconColors.color1)
  const [htmlIconColor, setHtmlIconColor] = useState(iconColors.color1)
  const [cssIconColor, setCssIconColor] = useState(iconColors.color1)
  const [javaScriptIconColor, setJavaScriptIconColor] = useState(iconColors.color1)
  const [nodeJSIconColor, setNodeJSIconColor] = useState(iconColors.color1)
  const [npmIconColor, setNpmIconColor] = useState(iconColors.color1)
  const [gitIconColor, setGitIconColor] = useState(iconColors.color1)
  ...
  const cellPhoneCards =  <div className='card-row'> 
  <div className='card' onMouseEnter={() => setReactIconColor(iconColors.color2)} onMouseLeave={() => setReactIconColor(iconColors.color1)}>
  <div className={darkMode ? "card-face front" : "card-face front front-white"}>
    <div className='card-content'>
      {reactIcon}
      <h3 className={darkMode ? 'card-title' : 'card-title card-title-white'}>React</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-face back' : 'card-face back back-white'}>
    <div className='card-content'>
      <p className='card-description'>
        Powerfull library created by Facebook. React is a User Interface (UI) library used to make dinamic and modular front front-white-end interfaces.
      </p>
    </div>
  </div>
</div>

<div className='card' onMouseEnter={() => setMongoIconColor(iconColors.color2)} onMouseLeave={() => setMongoIconColor(iconColors.color1)}>
  <div className={darkMode ? 'card-face front' : "card-face front front-white"}>
    <div className='card-content'>
      {mongoIcon}
      <h3 className={darkMode ? 'card-title' : 'card-title card-title-white'}>MongoDB</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-face back' : 'card-face back back-white'}>
    <div className='card-content'>
...
<div className='card' onMouseEnter={() => setMySQLIconColor(iconColors.color2)} onMouseLeave={() => setMySQLIconColor(iconColors.color1)}>
  <div className={darkMode ? "card-face front" : "card-face front front-white"}>
    <div className='card-content'>
      {mySQLIcon}
      <h3 className={darkMode ? 'card-title' : 'card-title card-title-white'}>MySQL</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-face back' : 'card-face back back-white'}>
    <div className='card-content'>
...
<div className='card' onMouseEnter={() => setNodeJSIconColor(iconColors.color2)} onMouseLeave={() => setNodeJSIconColor(iconColors.color1)}>
  <div className={darkMode ? "card-face front" : "card-face front front-white"}>
    <div className='card-content'>
      {nodeJSIcon}
      <h3 className={darkMode ? 'card-title' : 'card-title card-title-white'}>Node.JS</h3>
    </div>
  </div>setNode
  <div className={darkMode ? 'card-face back':'card-face back back-white'}>
    <div className='card-content'>
...
<div className='card' onMouseEnter={() => setNpmIconColor(iconColors.color2)} onMouseLeave={() => setNpmIconColor(iconColors.color1)}>
  <div className={darkMode ? "card-face front" : "card-face front front-white"}>
    <div className='card-content'>
      {npmIcon}
      <h3 className={darkMode ? 'card-title':'card-title card-title-white'}>npm</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-face back':'card-face back back-white'}>
    <div className='card-content'>
...
<div className='card' onMouseEnter={() => setGitIconColor(iconColors.color2)} onMouseLeave={() => setGitIconColor(iconColors.color1)}>
  <div className={darkMode ? 'card-face front' : "card-face front front-white"}>
    <div className='card-content'>
      {gitIcon}
      <h3 className={darkMode ? 'card-title':'card-title card-title-white'}>Git</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-face back' : 'card-face back back-white'}>
    <div className='card-content'>
...
<div className='card' onMouseEnter={() => setHtmlIconColor(iconColors.color2)} onMouseLeave={() => setHtmlIconColor(iconColors.color1)}>
  <div className={darkMode ? "card-face front" : "card-face front front-white"}>
    <div className='card-content'>
      {htmlIcon}
      <h3 className={darkMode ? 'card-title' : 'card-title card-title-white'}>HTML</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-title' : 'card-face back back-white'}>
    <div className='card-content'>
      <p className='card-description'>
...
<div className='card' onMouseEnter={() => setCssIconColor(iconColors.color2)} onMouseLeave={() => setCssIconColor(iconColors.color1)}>
  <div className={darkMode ? 'card-face front' : "card-face front front-white"}>
    <div className='card-content'>
      {cssIcon}
      <h3 className={darkMode ? 'card-title' : 'card-title card-title-white'}>CSS</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-face back' : 'card-face back back-white'}>
    <div className='card-content'>
...
<div className='card' onMouseEnter={() => setJavaScriptIconColor(iconColors.color2)} onMouseLeave={() => setJavaScriptIconColor(iconColors.color1)}>
  <div className={darkMode ? "card-face front" : "card-face front front-white"}>
    <div className='card-content'>
      {javaScriptIcon}
      <h3 className={darkMode ? 'card-title' : 'card-title card-title-white'}>JavaScript</h3>
    </div>
  </div>
  <div className={darkMode ? 'card-face back' : 'card-face back back-white'}>
    <div className='card-content'>
  ...
  const normalCards = <> <div className='card-row'>
...
<div className='card-row2'>
  ...
  return (
    ...
    {cellPhone && <h2 className={darkMode ? 'section-title section-title-white techs' : 'section-title techs'}>&lt;techs&gt;</h2>}

    {cellPhone && cellPhoneCards}

    {!cellPhone && normalCards}

      {!cellPhone && <h2 className={darkMode ? 'section-title techs' : 'section-title section-title-white techs'}>&lt;techs&gt;</h2>}
